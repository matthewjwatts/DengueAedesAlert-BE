1.	Real time function (for 2024)
  a.	Mosquito information (colouring a postal code):
    i.	2024 – information on a cumulative basis over 2024
...
aedes_non_matches <-  dplyr::left_join(aedes_data_filtered,dengue_data_filtered,  by = 'Postcode')

# create grey red
dengue_matches <-  dplyr::right_join(aedes_data_filtered,dengue_data_filtered,  by = 'Postcode')
dengue_non_matches <-  dplyr::right_join(aedes_data_filtered,dengue_data_filtered,  by = 'Postcode')
